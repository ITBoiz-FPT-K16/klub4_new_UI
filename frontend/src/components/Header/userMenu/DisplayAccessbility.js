const DisplayAccessbility = ({setVisible}) => {
  return (
    <div className="absolute_wrap">
        ...
        <div className="menu_main">
            ...
            <div className="manu_col">
                <span className="menu_span1">
                    Dark Mode
                </span>
        ...
        <div className="menu_main">
            ...
            <div className="manu_col">
                ...
                <span className="menu_span2">
                    Make your font size smaller so more contant can fit on the screen
                </span>
            </div>
        </div>
...
export default DisplayAccessbility